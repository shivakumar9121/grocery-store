...
<section class="wishlist">
   ...
   <?php
      $grand_total = 0;
      $select_wishlist = $conn->prepare("SELECT wishlist.*, products.quantity AS available_qty, products.unit 
                                         FROM wishlist 
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="availability">Available: <?= $fetch_wishlist['available_qty']; ?> <?= $fetch_wishlist['unit']; ?></div>
