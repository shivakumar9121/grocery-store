...
<section class="shopping-cart">
   ...
   <?php
      ...
      $select_cart = $conn->prepare("SELECT c.*, p.quantity AS stock_qty, p.unit FROM cart c JOIN products p ON c.pid = p.id WHERE c.user_id = ?");
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="available">Available: <?= $fetch_cart['stock_qty']; ?> <?= $fetch_cart['unit']; ?></div>
